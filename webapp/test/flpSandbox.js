		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#nsaprobacionesentel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsaprobacionesentel-display": {
								"semanticObject": "nsaprobacionesentel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.aprobacionesentel",
									"url": sap.ui.require.toUrl("ns/aprobacionesentel")
								}
							}
						}
					}
